...
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
   KC_ESC,                    KC_RALT,KC_LNG2,MO(_LOWER),KC_SPC,  KC_BSPC,MO(_RAISE),KC_LNG1,KC_RCTL,                   KC_DEL
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
  ),
...
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      QK_USER_10,KC_LEFT,KC_DOWN,KC_RGHT, _______, _______,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   _______,C(KC_LEFT),C(KC_RGHT),QK_USER_11,QK_USER_14,KC_DOT,                  _______, _______, _______, _______, _______, _______,
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+

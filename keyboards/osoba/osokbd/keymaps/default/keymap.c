...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x6_4(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    QK_USER_16, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, TL_LA,   TL_SRC,  KC_BSPC, TL_RA,   KC_RGUI
    ),
    [_LOWER] = LAYOUT_split_3x6_4(
        ...
        _______,  _______, _______, _______, _______, _______, KC_LNG2, KC_LEFT, KC_DOWN,  KC_RGHT, KC_MINUS, _______,
        _______,  _______, _______, _______, _______, _______, KC_LNG1, _______, _______,  _______, _______, _______,
        XXXXXXX,  XXXXXXX, XXXXXXX, _______, _______, _______, KC_DEL, _______, _______
    )
};
